...
export const metadata = {
  title: "Track Your Orders | Smart Gadget - Premium Gadget Store Bangladesh",
  description: "Track your gadget orders easily with your phone number. Check order status, delivery updates, and tracking information for all your purchases from Smart Gadget Bangladesh.",
  keywords: [
    ...
    "track my order",
    "gadget delivery tracking",
    "smartphone order tracking",
    "electronics order status",
    
    // Delivery tracking
    "track order by phone",
    "bangladesh gadget delivery",
    "order tracking system",
    "delivery status bd",
    "tech product tracking",
    "smart gadget order status",
    "online gadget tracking",
    "premium gadget delivery",
  ...
  twitter: {
    ...
    description: "Track all your gadget orders with your phone number. Check delivery status and order updates.",
    images: ['/track-twitter-image.jpg'],
  },
  alternates: {
    canonical: '/track',
    languages: {
  ...
  other: {
    ...
    'product-category': 'Gadgets, Electronics, Smartphones, Laptops, Accessories',
...
export const generateJsonLd = () => {
  return {
    ...
    description: 'Track your gadget orders easily with your phone number. Check order status, delivery updates, and tracking information.',
    url: process.env.NEXT_PUBLIC_BASE_URL + '/track' || 'https://smartgadget.com.bd/track',
    inLanguage: 'en',
    about: {
      '@type': 'Thing',
      name: 'Order Tracking',
      description: 'Track gadgets and electronics orders'
    },
    breadcrumb: {
      '@type': 'BreadcrumbList',
      itemListElement: [
    ...
    mainEntity: {
      ...
      description: 'Track gadget orders by phone number',
