...
// const OrderSuccessModal = ({ isOpen, onClose, orderId, isLoggedIn }) => {
...
//                 <p className="text-xs text-blue-700">A confirmation email has been sent to your email address.</p>
//               </div>
//             </div>
...
//       setAreas([]);
//     }
//   }, [formData.city, customCity, locationData, shippingRates]);
...
//       const response = await fetch('https://gadget-backend.vercel.app/api/cart', { headers });
//       const data = await response.json();
      
//       if (data.success && data.data.items?.length > 0) {
//         setCart(data.data);
//       } else {
//         // Set empty cart - NO REDIRECT
...
//       const response = await fetch(`https://gadget-backend.vercel.app/api/cart/${itemId}`, {
//         method: 'PUT',
//         headers,
...
//       // Don't fetch cart if we're in the middle of placing an order
...
//     if (!finalCity) newErrors.city = 'Please select a district/city';
//     if (!finalZone) newErrors.zone = 'Please select an upazila/thana';
...
//   //   setNavigating(true);
//   //   setSubmitting(true);
//   //   isPlacingOrder.current = true; // Set flag to prevent cart fetch redirect
...
//   //     const response = await fetch('https://gadget-backend.vercel.app/api/orders', {
//   //       method: 'POST',
//   //       headers,
...
//   //       if (isLoggedIn) {
//   //         // LOGGED IN USER - Navigate to orders page
//   //         toast.success('Order placed successfully!');
//   //         // Use window.location for clean navigation
//   //         window.location.href = '/customer/orders';
//   //       } else {
//   //         // GUEST USER - Show success modal, NO navigation
//   //         setShowOrderSuccessModal(true);
//   //         setLastOrderId(orderId);
//   //         setNavigating(false); // Reset navigation flag
//   //         toast.success('Order placed successfully!');
//   //       }
//   //     } else {
...
//   //   } finally {
//   //     setSubmitting(false);
//   //     isPlacingOrder.current = false; // Reset flag
//   //   }
//   // };
// const handleCODOrder = async () => {
//   if (isAdminOrModerator) {
...
//     const orderData = {
//       // CHANGE THIS: Map items to include unit
...
//         unit: item.unit || 'pcs'  // <-- ADD THIS LINE
//       })),
//       subtotal: calculateSubtotal(),
//       shippingCost,
//       discount: 0,
...
//                         onChange={handleInputChange}
//                         className="w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none transition text-sm"
//                         placeholder="01XXXXXXXXX"
//                       />
//                     </div>
//                     {isLoggedIn && user?.whatsapp && (
//                       <p className="text-[10px] text-blue-600 mt-1 flex items-center gap-1">
//                         <FaCheckCircle className="w-3 h-3" />
//                         Using saved WhatsApp number
//                       </p>
//                     )}
//                   </div>
//                 </div>
...
//                           className="w-full mt-2 px-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-black focus:border-transparent outline-none text-sm"
//                           required
//                         />
//                       )}
...
//                              {/* <p className="text-xs text-gray-500">Unit: {unit}</p> */}
...
//           // No automatic navigation - user must click a button
//         }}
//         orderId={lastOrderId}
...
//     {/* WhatsApp field completely removed */}
//   </div>
// </div>
//               {/* Delivery Address */}
//               <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
