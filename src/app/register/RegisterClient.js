...
//                   >
//                     <div className={`w-8 h-8 rounded-lg bg-${benefit.color}/10 flex items-center justify-center mx-auto mb-1`}>
//                       <Icon className={`w-4 h-4 text-${benefit.color.replace('#', '')}`} style={{ color: benefit.color }} />
//                     </div>
...
//                     className="w-full mt-5 bg-black text-white py-2 rounded-lg font-semibold text-sm hover:from-blue-700 hover:to-blue-600 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
//                   >
//                     {isSubmitting ? (
//                       <>
...
//                   <div className="w-14 h-14 bg-gradient-to-r from-blue-600 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
...
//                     placeholder="000000"
//                     className="w-full px-4 py-2 text-center text-xl tracking-wider border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all font-mono"
//                     autoFocus
...
//                   className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-600 transition-all disabled:opacity-50 text-sm"
//                 >
//                   {isVerifying ? (
...
//                     className="text-xs text-blue-600 hover:text-blue-700 transition-colors disabled:opacity-50 font-medium"
//                   >
        ...
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)]">
          ...
          <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden min-h-[500px]">
            ...
            <div 
              ...
              style={{
                backgroundImage: 'url(https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=1200&h=800&fit=crop)',
