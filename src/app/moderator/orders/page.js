...
//                     {/* <th className="px-3 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Method</th> */}
...
//                           </button>
//                         </td>
//                         {/* <td className="px-3 py-3 text-center">{getPaymentMethodBadge(order.paymentMethod)}</td> */}
