...
//                     Category Management
//                   </h1>
//                   <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-blue-100 text-pink-600 text-[10px] sm:text-xs font-medium rounded-full whitespace-nowrap">
//                     Moderator
//                   </span>
//                 </div>
...
//                   Total: <span className="font-semibold text-black">{categories.length}</span> categories
//                 </div>
//                 <button
...
//                           imageError ? 'border-red-300 bg-red-50' : errors.image ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-black hover:bg-orange-50'
//                         }`}
//                         onClick={() => {
//                           setImageError('');
//                           fileInputRef.current?.click();
...
//                     className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none transition ${
...
//                     onChange={handleChange}
//                     rows="3"
//                     className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none transition"
...
//                   className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-black text-white font-medium rounded-lg hover:bg-[#18181B] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
//                 >
//                   {isSubmitting ? (
//                     <>
...
//                       className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none transition placeholder:text-gray-400"
//                     />
//                   </div>
//                 </div>
//               </div>
...
//                               className="flex items-center gap-1.5 px-2 py-1 bg-blue-50 text-pink-600 rounded-lg hover:bg-blue-100 transition-colors text-xs font-medium"
//                             >
//                               <FolderTree className="w-3.5 h-3.5" />
...
//                                 className="p-1.5 text-gray-600 hover:text-black hover:bg-orange-50 rounded-lg transition-colors"
//                                 title="View Details"
//                               >
...
//                                 className="p-1.5 text-gray-600 hover:text-pink-600 hover:bg-blue-50 rounded-lg transition-colors"
//                                 title="Edit"
//                               >
...
//                                   }}
//                                   className="p-1 text-gray-400 hover:text-pink-600 hover:bg-blue-50 rounded transition-colors"
...
//                   }}
//                   className="px-3 py-1.5 text-xs font-medium text-black hover:bg-orange-50 rounded-lg transition-colors flex items-center gap-1"
//                 >
//                   <Edit className="w-3.5 h-3.5" />
//                   Edit Category
//                 </button>
...
//                     }}
//                     className="mt-3 px-4 py-2 bg-black text-white text-sm rounded-lg hover:bg-black"
//                   >
...
//                               }}
//                               className="p-1.5 text-gray-600 hover:text-pink-600 hover:bg-blue-50 rounded-lg"
//                               title="Edit Subcategory"
//                             >
//                               <Edit className="w-3.5 h-3.5" />
//                             </button>
...
//                                         }}
//                                         className="p-1 text-gray-400 hover:text-pink-600 hover:bg-blue-50 rounded"
...
//                 className="px-4 py-2 bg-black text-white text-sm rounded-lg hover:bg-black flex items-center gap-2"
//               >
//                 <Plus className="w-4 h-4" />
//                 Add Subcategory
//               </button>
...
//                   className="flex items-center gap-2 px-3 py-2 text-sm text-black hover:bg-[#ede4de] rounded-lg transition-colors"
//                 >
//                   <Plus className="w-4 h-4" />
...
//                     className="flex items-center gap-2 px-4 py-2 bg-black text-white text-sm font-medium rounded-lg hover:bg-[#38737a] transition-colors disabled:opacity-50"
//                   >
...
//                           editModal.imageError ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-black hover:bg-orange-50'
//                         }`}
//                         onClick={() => {
...
const fetchCategories = async () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50/50 via-white to-rose-50/30">
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <Link 
                href="/moderator/dashboard" 
                className="p-1.5 sm:p-2 hover:bg-pink-50 rounded-lg transition-colors flex-shrink-0"
              >
                <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600" />
              </Link>
              <div className="min-w-0 flex-1">
      ...
      {/* All the modals remain the same but with beauty theme colors */}
      {/* View Category Modal with Expandable Subcategories */}
      {viewModal.show && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
      ...
      {/* View Subcategories Modal - same beauty theme styling as admin but with moderator colors */}
      {viewSubcategoriesModal.show && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
      ...
      {/* All other modals (Add Subcategory, Edit Subcategory, etc.) - same beauty theme styling */}
