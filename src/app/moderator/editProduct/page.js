...
//     if (isOwnBarcode) {
//       return <span className="text-pink-600 text-xs">✓ Current product barcode (no change)</span>;
//     }
...
//           className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-pink-600 transition disabled:opacity-50 flex items-center gap-2 whitespace-nowrap"
//         >
//           {isScannerMode ? (
...
//               <span className="text-sm text-pink-700">Scanner mode active - Scan barcode now</span>
//             </div>
//             <button
//               type="button"
...
//                                 <p className="text-base font-medium text-pink-700 line-clamp-1">
//                                   {formData.metaSettings.metaTitle}
//                                 </p>
//                               )}
//                               {formData.metaSettings.metaTitle && (
