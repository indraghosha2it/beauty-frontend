...
// Default banner background image - Beauty themed
const DEFAULT_BG_IMAGE = '/images/banner.jpeg';

// Banner draft key for localStorage
const BANNER_DRAFT_KEY = 'moderator_beauty_banner_draft';
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-xl font-bold text-gray-900">Create Beauty Banner</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleSaveDraft}
                disabled={isSavingDraft}
                className="px-4 py-2 text-sm bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors flex items-center gap-2 disabled:opacity-50"
              >
                {isSavingDraft ? <Loader2 className="w-4 h-4 animate-spin" /> : <Save className="w-4 h-4" />}
                Save Draft
              </button>
      ...
      <div className="p-6">
        <form onSubmit={handleSubmit}>
                ...
                <div className="p-5 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      value={formData.title}
                      onChange={handleChange}
                      className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${errors.title ? 'border-red-500' : 'border-gray-300'}`}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="3"
                      className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition resize-none ${errors.description ? 'border-red-500' : 'border-gray-300'}`}
                      placeholder="Write a compelling description for the banner..."
                    />
                    {errors.description && <p className="text-xs text-red-600 mt-1">{errors.description}</p>}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={formData.badge}
                        onChange={handleChange}
                        className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${errors.badge ? 'border-red-500' : 'border-gray-300'}`}
                        placeholder="e.g., ✨ Limited Edition, Best Seller"
                      />
                      {errors.badge && <p className="text-xs text-red-600 mt-1">{errors.badge}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={formData.discount}
                        onChange={handleChange}
                        className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${errors.discount ? 'border-red-500' : 'border-gray-300'}`}
                        placeholder="e.g., 40% OFF, New Arrival"
                      />
                      {errors.discount && <p className="text-xs text-red-600 mt-1">{errors.discount}</p>}
                    </div>
                    ...
                    {formData.features.map((feature, index) => (
                      <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <input
                          ...
                          onChange={(e) => updateFeature(index, 'text', e.target.value)}
                          placeholder="Feature text..."
                          className={`flex-1 px-3 py-1.5 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${errors[`feature_${index}`] ? 'border-red-500' : 'border-gray-300'}`}
                        />
                        <button
                          type="button"
                          onClick={() => removeFeature(index)}
                    ...
                    <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="flex-1 w-full">
                        <input
                          ...
                          onChange={(e) => updateButton(index, 'text', e.target.value)}
                          placeholder="Button text..."
                          className={`w-full px-3 py-1.5 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${errors[`button_${index}_text`] ? 'border-red-500' : 'border-gray-300'}`}
                        />
                      </div>
                      <div className="flex-1 w-full">
                        <input
                          ...
                          onChange={(e) => updateButton(index, 'link', e.target.value)}
                          placeholder="Button link..."
                          className={`w-full px-3 py-1.5 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${errors[`button_${index}_link`] ? 'border-red-500' : 'border-gray-300'}`}
                        />
                      </div>
                      <div className="flex items-center gap-2">
                        <label className="flex items-center gap-1 text-xs text-gray-600">
          ...
          {/* Full Width Preview Section - Beauty Style */}
          <div className="mt-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#FFF5F6]/70 via-[#FFE4E8]/40 to-transparent" />
                
                {/* Decorative Beauty Elements */}
                <div className="absolute top-0 right-0 w-1/3 h-full bg-pink-500/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
                <div className="absolute bottom-0 left-0 w-1/4 h-1/2 bg-purple-500/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
                  ...
                  <div className="container mx-auto">
                    <div className="flex items-center gap-8">
                      ...
                      <div className="flex-1 max-w-2xl">
                        ...
                        {formData.badge && (
                          <div className="mb-2 sm:mb-3">
                            <span className="inline-block px-4 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-pink-600 bg-white/90 backdrop-blur-md rounded-full border border-pink-200 shadow-sm">
                              ✨ {formData.badge}
                            </span>
                          </div>
                        )}
                        ...
                        {/* Title */}
                        {formData.title && (
                          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-2 sm:mb-3 leading-tight" 
                        ...
                        {/* Description */}
                        {formData.description && (
                          <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-4 sm:mb-5 line-clamp-2 max-w-xl" 
                             style={{ fontFamily: "'Playfair Display', 'Georgia', serif" }}>
                            {formData.description}
                          </p>
                        )}
                        ...
                        {formData.features.length > 0 && (
                          <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-5">
                            {formData.features.map((feature, idx) => {
                              const IconComponent = FEATURE_ICONS.find(f => f.value === feature.icon)?.icon;
                              return (
                                <div key={idx} className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/80 backdrop-blur-md rounded-full border border-pink-200 shadow-sm">
                                  {IconComponent && <span className="w-4 h-4 sm:w-5 sm:h-5 text-pink-500">{IconComponent}</span>}
                                  <span className="text-gray-700 text-xs sm:text-sm font-medium" style={{ fontFamily: "'Playfair Display', 'Georgia', serif" }}>
                                    {feature.text}
                                  </span>
                                </div>
                              );
                              ...
                              button.text && button.link && (
                                <button
                                  ...
                                  className={`px-6 sm:px-8 py-2 sm:py-2.5 text-sm sm:text-base rounded-full font-semibold transition-all ${
                                    button.isPrimary
                                      ? 'bg-pink-500 text-white hover:bg-pink-600 shadow-lg hover:shadow-xl hover:scale-105'
                                      : 'bg-white/80 backdrop-blur-md border border-pink-200 text-gray-700 hover:bg-white hover:shadow-lg hover:scale-105'
                                  }`}
                                  style={{ fontFamily: "'Playfair Display', 'Georgia', serif" }}
                                >
                                  {button.text}
                      ...
                      {/* Right Side - Product Image in Oval Shape */}
                      {getCurrentProductImage() && (
                        <div className="hidden md:block flex-shrink-0">
                          <div className="relative w-64 sm:w-72 md:w-80 lg:w-96 xl:w-[420px]">
                            <div className="relative rounded-[50%] overflow-hidden shadow-2xl border-4 border-white/50"
                                 style={{
                                   width: '100%',
                                   aspectRatio: '3/4',
                              ...
                              />
                              <div className="absolute inset-0 rounded-[50%] bg-gradient-to-t from-pink-500/10 via-transparent to-transparent pointer-events-none" />
                              <div className="absolute inset-2 rounded-[50%] border-2 border-white/30 pointer-events-none" />
                            </div>
                            <div className="absolute -inset-4 rounded-[50%] bg-pink-500/10 blur-3xl -z-10" />
                          </div>
                        </div>
                      )}
                    </div>
                ...
                {formData.discount && (
                  <div className="absolute top-4 sm:top-6 md:top-8 right-4 sm:right-6 md:right-8">
                    <div className="relative group">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center shadow-2xl border-4 border-white/30 hover:scale-110 transition-transform duration-300">
                        <div className="text-center">
                          <div className="text-white font-black text-xs sm:text-sm md:text-base lg:text-xl leading-tight" style={{ fontFamily: "'Playfair Display', 'Georgia', serif" }}>
                            {formData.discount}
                          </div>
                          <div className="text-white/90 text-[6px] sm:text-[8px] md:text-[10px] font-medium">OFF</div>
                        </div>
                      </div>
                      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-pink-400 to-rose-500 blur-md opacity-50 -z-10 group-hover:opacity-70 transition-opacity" />
                ...
                {featuredProducts.length > 0 && (
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 w-[90%] max-w-4xl">
                    <div className="flex gap-2">
                      {featuredProducts.map((item, index) => (
                        <div key={index} className="flex-1 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:border-pink-300/50 transition-all overflow-hidden shadow-sm hover:shadow-md">
                          <div className="flex items-center gap-2 p-2.5">
                            <div className="w-14 h-14 rounded-lg overflow-hidden flex-shrink-0 bg-white/20 border border-white/10">
                              <img
                                src={item.selectedImage}
                                alt={item.product.productName}
                                className="w-full h-full object-cover"
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-xs font-medium text-gray-800 truncate" style={{ fontFamily: "'Playfair Display', 'Georgia', serif" }}>
                                {item.product.productName}
                              </p>
                              {item.product.discountPrice > 0 ? (
                                <div className="flex items-center gap-1.5">
                                  <span className="text-xs font-bold text-pink-500">৳{item.product.discountPrice}</span>
                                  <span className="text-[9px] text-gray-400 line-through">৳{item.product.regularPrice}</span>
                                </div>
                              ) : (
                                <span className="text-xs font-bold text-gray-700">৳{item.product.regularPrice}</span>
                              )}
                            </div>
                            <button
                              onClick={() => window.open(`/productDetails?id=${item.productId}`, '_blank')}
                              className="flex-shrink-0 px-3 py-1.5 text-[10px] font-semibold text-white bg-pink-500 rounded-lg hover:bg-pink-600 transition-colors shadow-md hover:shadow-lg whitespace-nowrap"
                              style={{ fontFamily: "'Playfair Display', 'Georgia', serif" }}
                            >
                              Shop Now
                            </button>
                ...
                {/* Moderator Badge */}
                <div className="absolute bottom-4 left-4 bg-pink-500/80 text-white text-xs px-3 py-1 rounded-full flex items-center gap-2">
                  <UserCog className="w-3 h-3" />
                  <span>Moderator</span>
                </div>
              </div>
          ...
          <div className="mt-8 flex justify-end">
            <button
              type="submit"
              disabled={isSubmitting}
              className="flex items-center gap-2 px-6 py-3 bg-pink-500 text-white font-medium rounded-lg hover:bg-pink-600 transition-colors disabled:opacity-50 text-sm shadow-md hover:shadow-lg"
            >
              {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <Save className="w-4 h-4" />}
              {isSubmitting ? 'Creating Banner...' : 'Create Banner'}
            </button>
