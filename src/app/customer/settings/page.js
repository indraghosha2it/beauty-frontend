...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#FFF9F0] to-[#D4EDEE] relative overflow-hidden">
...
//       <div className="container mx-auto  max-w-4xl pt-4 md:pt-6  relative z-10">
//         {/* Header */}
//         <div className="mb-6">
...
//             <User className="w-6 h-6 md:w-7 md:h-7 text-[#4A8A90]" />
//             My Profile
//           </h1>
...
//                   <p className="text-xs text-gray-600 mt-1">Your personal details and account information</p>
//                 </div>
...
//                           <span className="px-2 py-1 bg-pink-100 text-pink-800 rounded-full text-xs font-medium border border-pink-200">
//                             📧 Subscribed
//                           </span>
//                         )}
//                       </div>
...
//                             <p className="text-sm text-gray-900">{userData.zipCode || 'Not provided'}</p>
//                           </div>
//                         </div>
//                       </div>
//                     </div>
...
//                               {userData.emailVerified ? '✓ Verified' : '⚠️ Not Verified'}
//                             </p>
//                           </div>
//                         </div>
//                       </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm ml-11">Manage your account information and preferences</p>
        </div>
