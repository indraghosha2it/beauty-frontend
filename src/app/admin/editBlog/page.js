      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-[#588D94] focus:border-transparent outline-none transition ${
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-[#588D94]" />
      </div>
    );
  }
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#588D94] focus:border-transparent outline-none transition"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                  ...
                  <textarea
                    ...
                    rows="4"
                    className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-[#588D94] focus:border-transparent outline-none transition resize-none ${
                  ...
                  <div className="mb-4 pb-4 border-b border-gray-200">
                    <label className="flex items-center gap-2 text-sm text-gray-700">
                      <input
                        ...
                        className="w-4 h-4 text-[#588D94] border-gray-300 rounded focus:ring-[#588D94]"
                      />
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <input
                        ...
                        className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#588D94] focus:border-transparent outline-none transition"
                      />
                      <button
                        type="button"
                        onClick={addTag}
                        className="px-4 py-2 bg-[#588D94] text-white text-sm font-medium rounded-lg hover:bg-[#317781] transition-colors"
                      >
                        Add
                      </button>
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                  <div className="p-5 border-b border-gray-200">
                    <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                      <ImageIcon className="w-5 h-5 text-[#588D94]" />
                    ...
                    {featuredImage.preview ? (
                      ...
                      <div 
                        className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors cursor-pointer ${
                          featuredImage.error ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-[#588D94] hover:bg-orange-50'
                        }`}
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                  <div className="p-5 border-b border-gray-200">
                    <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                      <ImagePlus className="w-5 h-5 text-[#588D94]" />
                      Thumbnail Images
                    </h2>
                  ...
                  <div className="p-5">
                            ...
                            <div
                              ...
                              className={`relative rounded-lg overflow-hidden border border-gray-200 aspect-square transition-all duration-200 ${
                                ...
                                dragOverIndex === index && draggedIndex !== index && draggedIndex !== null 
                                  ? 'ring-2 ring-[#588D94] ring-offset-2' 
                                  : ''
                              }`}
                            >
                              {/* Drag handle */}
                    ...
                    {/* Upload Button */}
                    <div 
                      className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center transition-colors cursor-pointer hover:border-[#588D94] hover:bg-orange-50"
            ...
            <div className="mb-6">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                <div className="p-5 border-b border-gray-200">
                  <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                    <BookOpen className="w-5 h-5 text-[#588D94]" />
            ...
            <div className="mb-6">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                <div className="p-5 border-b border-gray-200">
                  <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                    <Plus className="w-5 h-5 text-[#588D94]" />
                    Additional Sections
                  </h2>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="p-5 space-y-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-[#588D94] border-2 border-dashed border-[#588D94]/30 rounded-lg hover:bg-orange-50 hover:border-[#588D94] transition-colors"
                  >
            ...
            <div className="mb-6">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                <div className="p-5 border-b border-gray-200">
                  <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                    <Globe className="w-5 h-5 text-[#588D94]" />
                    SEO Settings
                  </h2>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="3"
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#588D94] focus:border-transparent outline-none transition resize-none"
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-[#588D94] text-white font-medium rounded-lg hover:bg-[#317781] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
                {isSubmitting ? (
                  <>
