...
export default function CertificationsPage() {
  ...
  const fetchCertifications = async () => {
    try {
      ...
      const response = await fetch('https://gadget-backend.vercel.app/api/certifications/admin/all', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingCert 
        ? `https://gadget-backend.vercel.app/api/certifications/admin/${editingCert._id}`
        : 'https://gadget-backend.vercel.app/api/certifications';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://gadget-backend.vercel.app/api/certifications/admin/${id}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      const data = await response.json();
  ...
  const handleToggleStatus = async (id, currentStatus) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://gadget-backend.vercel.app/api/certifications/admin/${id}/toggle`, {
        method: 'PUT',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      const data = await response.json();
