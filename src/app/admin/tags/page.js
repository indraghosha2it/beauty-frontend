...
export default function TagsManagementPage() {
  ...
  // Add this to track if image was changed
  ...
  // Handle removing the current image (reset to empty state)
  const handleRemoveImage = () => {
    setTagImage(null);
    setTagImagePreview('');
    setIsImageChanged(true);
    // Don't set existingImageUrl here - we want to track that user wants to remove the image
  };
  ...
  const handleUpdateTag = async () => {
    ...
    try {
      ...
      // Case 1: User wants to remove the image entirely - but we require an image
      // So we keep the existing image
      if (tagImagePreview === '' && !isImageChanged) {
        // No image - keep existing
        imageData = {
      ...
      // Case 3: User wants to keep the existing image (no changes)
      else {
        imageData = {
          url: existingImageUrl,
          publicId: existingPublicId
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage product tags for your store</p>
        </div>
        <button
          onClick={() => setShowCreateModal(true)}
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-lg hover:bg-pink-700 transition-colors"
        >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg hover:bg-pink-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {tagImagePreview && (
                      <button
                        onClick={() => {
                          // Trigger file input click to change image
