...
//                 Total: <span className="font-semibold text-[#558C92]">{categories.length}</span> categories
//               </div>
...
//                   <Plus className="w-5 h-5 text-[#558C92]" />
//                   Add New Category
//                 </h2>
//               </div>
...
//                           imageError ? 'border-red-300 bg-red-50' : errors.image ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-[#558C92] hover:bg-orange-50'
//                         }`}
//                         onClick={() => {
//                           setImageError('');
//                           fileInputRef.current?.click();
...
//                     className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-[#558C92] focus:border-transparent outline-none transition ${
...
//                     onChange={handleChange}
//                     rows="3"
//                     className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#558C92] focus:border-transparent outline-none transition"
...
//                   className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-black text-white font-medium rounded-lg hover:bg-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
//                 >
//                   {isSubmitting ? (
//                     <>
...
//                       className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#558C92] focus:border-transparent outline-none transition placeholder:text-gray-400"
//                     />
//                   </div>
//                 </div>
//               </div>
...
//                           <Loader2 className="w-6 h-6 animate-spin mx-auto text-[#558C92]" />
//                         </td>
//                       </tr>
...
//                               <button onClick={() => handleViewClick(category)} className="p-1.5 text-gray-600 hover:text-[#558C92] hover:bg-orange-50 rounded-lg transition-colors" title="View Details">
...
//                     <Hash className="w-3.5 h-3.5 text-[#558C92]" />
...
//                     <FolderTree className="w-3.5 h-3.5 text-[#558C92]" />
...
//                           <Loader2 className="w-4 h-4 animate-spin text-[#558C92]" />
...
//                 <div className="bg-gray-50 rounded-lg p-3">
//                   <div className="flex items-center gap-2 mb-1">
//                     <Package className="w-3.5 h-3.5 text-[#558C92]" />
...
//                 <div className="bg-gray-50 rounded-lg p-3">
//                   <div className="flex items-center gap-2 mb-1">
//                     <Calendar className="w-3.5 h-3.5 text-[#558C92]" />
...
//                 <div className="bg-gray-50 rounded-lg p-3">
//                   <div className="flex items-center gap-2 mb-1">
//                     <User className="w-3.5 h-3.5 text-[#558C92]" />
...
//                 <div className="bg-gray-50 rounded-lg p-3">
//                   <div className="flex items-center gap-2 mb-1">
//                     <Clock className="w-3.5 h-3.5 text-[#558C92]" />
...
//                   <div className="flex items-center gap-2 mb-1">
//                     <FileText className="w-3.5 h-3.5 text-[#558C92]" />
...
//                   }}
//                   className="px-3 py-1.5 text-xs font-medium text-[#558C92] hover:bg-orange-50 rounded-lg transition-colors flex items-center gap-1"
//                 >
//                   <Edit className="w-3.5 h-3.5" />
//                   Edit Category
//                 </button>
...
//             <Loader2 className="w-8 h-8 animate-spin mx-auto text-[#558C92]" />
...
//               }}
//               className="mt-3 px-4 py-2 bg-[#558C92] text-white text-sm rounded-lg hover:bg-[#55351C]"
//             >
...
//           className="px-4 py-2 bg-[#558C92] text-white text-sm rounded-lg hover:bg-[#55351C] flex items-center gap-2"
//         >
//           <Plus className="w-4 h-4" />
//           Add Subcategory
//         </button>
...
//                           className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#558C92] focus:border-transparent outline-none"
...
//                   className="flex items-center gap-2 px-3 py-2 text-sm text-blue-600 hover:bg-[#ede4de] rounded-lg transition-colors"
//                 >
//                   <Plus className="w-4 h-4" />
...
//                     className="flex items-center gap-2 px-4 py-2 bg-black text-white text-sm font-medium rounded-lg hover:bg-black transition-colors disabled:opacity-50"
//                   >
...
//                     <Edit className="w-5 h-5 text-[#558C92]" />
//                   </div>
...
//                     className="flex items-center gap-2 px-4 py-2 bg-[#558C92] text-white text-sm font-medium rounded-lg hover:bg-[#2a5f65] transition-colors disabled:opacity-50"
//                   >
...
//               <div className="flex items-center justify-between mb-6">
//                 <div className="flex items-center gap-3">
//                   <div className="p-2 bg-[#558C92]/10 rounded-lg">
//                     <Edit className="w-5 h-5 text-[#558C92]" />
//                   </div>
...
//                           editModal.imageError ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-[#558C92] hover:bg-orange-50'
//                         }`}
//                         onClick={() => {
...
//                     type="submit"
//                     disabled={isSubmitting}
//                     className="flex items-center gap-2 px-4 py-2 bg-[#558C92] text-white text-sm font-medium rounded-lg hover:bg-[#1f5c63] transition-colors disabled:opacity-50"
//                   >
//                     {isSubmitting ? (
//                       <>
//                         <Loader2 className="w-4 h-4 animate-spin" />
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50/50 via-white to-rose-50/30">
      ...
      <div className="bg-white/80 backdrop-blur-md border-b border-pink-100 sticky top-0 z-10 shadow-sm">
        <div className="px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-2 sm:gap-4">
              <Link href="/admin/dashboard" className="p-1.5 sm:p-2 hover:bg-pink-50 rounded-lg transition-colors flex-shrink-0">
                <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600" />
              </Link>
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                  <h1 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent truncate">
                    Category Management
                  </h1>
                  <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-gradient-to-r from-pink-100 to-rose-100 text-pink-600 text-[10px] sm:text-xs font-medium rounded-full whitespace-nowrap">
                    Admin
                  </span>
                </div>
                <p className="text-xs sm:text-sm text-gray-500 mt-0.5 sm:mt-1 truncate">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3">
              <div className="text-xs sm:text-sm text-gray-600 bg-gradient-to-r from-pink-50/50 to-rose-50/50 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg border border-pink-100">
                Total: <span className="font-semibold text-pink-600">{categories.length}</span> categories
              </div>
              <button onClick={fetchCategories} className="p-1.5 sm:p-2 text-gray-600 hover:bg-pink-50 rounded-lg transition-colors" title="Refresh">
                <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5" />
              </button>
            </div>
          </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
          {/* Left Column - Create Form */}
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-pink-100 sticky top-24">
              <div className="p-5 border-b border-pink-100 bg-gradient-to-r from-pink-50/30 to-rose-50/30">
                <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
              ...
              <form onSubmit={handleSubmit} className="p-5 space-y-4">
                ...
                <div>
                  ...
                  {!imagePreview ? (
                    <>
                      <div 
                        className={`border-2 border-dashed rounded-lg p-4 text-center transition-colors cursor-pointer ${
                          imageError ? 'border-rose-300 bg-rose-50' : errors.image ? 'border-rose-300 bg-rose-50' : 'border-pink-200 hover:border-pink-400 hover:bg-pink-50'
                        }`}
                        onClick={() => {
                          setImageError('');
                          fileInputRef.current?.click();
                      ...
                      >
                        <input 
                          ...
                          onChange={handleImageChange} 
                        />
                        <Upload className={`w-8 h-8 mx-auto mb-2 ${imageError || errors.image ? 'text-rose-400' : 'text-pink-400'}`} />
                        <p className={`text-xs ${imageError || errors.image ? 'text-rose-600' : 'text-gray-600'}`}>
                          Click to upload
                        </p>
                        <p className="text-xs text-gray-400 mt-2">
                          Allowed formats: JPG, JPEG, PNG, WebP (max 5MB)
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button type="button" onClick={removeImage} className="flex-1 flex items-center justify-center gap-1 px-3 py-2 bg-rose-50 text-rose-600 text-xs font-medium rounded-lg hover:bg-rose-100 transition-colors">
                          <Trash2 className="w-3.5 h-3.5" />
                          Remove
                        </button>
                      </div>
                  ...
                  {errors.image && !imagePreview && !imageError && (
                    <p className="text-xs text-rose-600 mt-1">{errors.image}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition ${
                      errors.name ? 'border-rose-500' : 'border-pink-200'
                    } bg-pink-50/30 hover:bg-white`}
                    placeholder="e.g., T-Shirts"
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full px-3 py-2 text-sm border border-pink-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition bg-pink-50/30 hover:bg-white"
                    placeholder="Brief description (optional)"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-pink-200/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm shadow-md"
                >
                  {isSubmitting ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-pink-100 overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="relative w-64">
                    ...
                    <input
                      ...
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="w-full pl-10 pr-4 py-2 text-sm border border-pink-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition placeholder:text-gray-400 bg-pink-50/30 hover:bg-white"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-pink-50/50 to-rose-50/50">
                    <tr>
                      <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Image</th>
                      <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Name</th>
                      <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Description</th>
                      <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <div className="flex items-center gap-1">
                          <FolderTree className="w-3.5 h-3.5 text-pink-400" />
                          SubCategories
                        </div>
                      </th>
                      <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    ...
                    {isLoading ? (
                      ...
                      filteredCategories.map((category) => (
                        <tr key={category._id} className="hover:bg-pink-50/50 transition-colors">
                          <td className="px-5 py-3">
                            <div className="w-12 h-12 rounded-lg overflow-hidden border border-pink-200">
                              <img 
                                src={category.image?.url || '/placeholder-image.jpg'} 
                                alt={category.name}
                                className="w-full h-full object-cover"
                          ...
                          <td className="px-5 py-3">
                            <button
                              onClick={() => handleViewSubcategories(category)}
                              className="flex items-center gap-1.5 px-2 py-1 bg-gradient-to-r from-blue-50 to-cyan-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors text-xs font-medium border border-blue-200"
                            >
                              <FolderTree className="w-3.5 h-3.5" />
                              {category.subcategoryCount || 0} Total
                              <ChevronRight className="w-3 h-3" />
                          ...
                          <td className="px-5 py-3">
                            <div className="flex items-center justify-end gap-2">
                              <button onClick={() => handleViewClick(category)} className="p-1.5 text-gray-600 hover:text-pink-600 hover:bg-pink-50 rounded-lg transition-colors" title="View Details">
                                <Eye className="w-4 h-4" />
                              </button>
                              <button onClick={() => handleAddSubcategory(category)} className="p-1.5 text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors" title="Add Subcategory">
                                <Plus className="w-4 h-4" />
                              ...
                              <div className="relative group">
                                ...
                                {category.productCount > 0 && (
                                  <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 w-48 text-center shadow-lg">
                                    <div className="flex items-start gap-1.5">
                                      <Info className="w-3.5 h-3.5 flex-shrink-0 mt-0.5 text-pink-300" />
                                      <span className="leading-tight break-words text-left">
                                        Cannot delete - This category has {category.productCount} product{category.productCount !== 1 ? 's' : ''}
                                      </span>
                                    </div>
              ...
              <div className="px-5 py-3 border-t border-pink-100 bg-gradient-to-r from-pink-50/30 to-rose-50/30">
                <p className="text-xs text-gray-500">
                  Showing {filteredCategories.length} of {categories.length} categories
                </p>
              </div>
      ...
      {viewModal.show && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 overflow-hidden max-h-[90vh] overflow-y-auto border border-pink-100">
            <div className="flex items-center justify-between px-6 py-4 border-b border-pink-100 sticky top-0 bg-white/80 backdrop-blur-sm z-10">
              <div className="flex items-center gap-3">
              ...
              <button onClick={handleViewClose} className="p-1.5 hover:bg-pink-50 rounded-lg transition-colors">
                <X className="w-5 h-5 text-gray-500" />
              </button>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gradient-to-r from-pink-50/50 to-rose-50/50 rounded-lg p-3 border border-pink-100">
                  ...
                  <button
                    onClick={() => setExpandedSubcategories(!expandedSubcategories)}
                    className="w-full flex items-center justify-between px-3 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 hover:bg-blue-100 rounded-lg transition-colors group border border-blue-200"
                  >
                    <div className="flex items-center gap-2">
                      <FolderTree className="w-4 h-4 text-blue-600" />
                      <span className="text-sm font-medium text-blue-700">
                  ...
                  {expandedSubcategories && (
                    <div className="mt-3 pt-3 border-t border-pink-100">
                      {isLoadingSubcategories ? (
                        ...
                        <div className="space-y-2 max-h-48 overflow-y-auto">
                          {viewSubcategoriesList.map((sub, idx) => (
                            <div key={sub._id} className="flex items-center justify-between p-2 bg-white rounded-lg border border-pink-100 hover:shadow-sm transition-shadow">
                              <div className="flex items-center gap-2 flex-1 min-w-0">
                                <span className="text-xs text-gray-400 font-mono flex-shrink-0 w-5">#{idx + 1}</span>
                                <span className="text-sm font-medium text-gray-800 truncate">{sub.name}</span>
                                {sub.productCount > 0 && (
                ...
                <div className="col-span-2 bg-gradient-to-r from-pink-50/50 to-rose-50/50 rounded-lg p-3 border border-pink-100">
                  <div className="flex items-center gap-2 mb-1">
              ...
              <div className="flex justify-end gap-2 mt-6 pt-4 border-t border-pink-100">
                <button
                  onClick={() => {
                    handleViewClose();
                    handleAddSubcategory(viewModal.category);
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-medium text-pink-600 hover:bg-pink-50 rounded-lg transition-colors flex items-center gap-1 border border-pink-200"
                >
                  <Edit className="w-3.5 h-3.5" />
                  Edit Category
                </button>
      ...
      {viewSubcategoriesModal.show && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden border border-pink-100">
            <div className="flex items-center justify-between px-6 py-4 border-b border-pink-100 bg-gradient-to-r from-pink-50/30 to-rose-50/30">
              <div>
                <h2 className="text-lg font-semibold text-gray-900">
                  Subcategories: {viewSubcategoriesModal.category?.name}
                </h2>
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              {viewSubcategoriesModal.isLoading ? (
                ...
                <div className="text-center py-12">
                  <FolderTree className="w-12 h-12 mx-auto text-pink-200 mb-3" />
                  <p className="text-gray-500">No subcategories found</p>
                  <button
                    onClick={() => {
                      setViewSubcategoriesModal({ show: false, category: null, subcategories: [], isLoading: false, expandedChildren: {} });
                    ...
                    className="mt-3 px-4 py-2 bg-gradient-to-r from-pink-500 to-rose-500 text-white text-sm rounded-lg hover:shadow-lg hover:shadow-pink-200/50 transition-all shadow-md"
                  >
                    Add First Subcategory
                  </button>
                </div>
                ...
                <div className="space-y-2">
                  {viewSubcategoriesModal.subcategories.map((sub, index) => {
                    ...
                    return (
                      <div key={sub._id} className="border border-pink-200 rounded-lg overflow-hidden">
                        {/* Parent Subcategory */}
                        <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-50/30 to-rose-50/30 hover:bg-pink-50 transition-colors">
                          <div className="flex items-center gap-3 flex-1">
                            {childCount > 0 ? (
                              <button
                                onClick={() => toggleViewChildren(sub._id)}
                        ...
                        {/* Child Subcategories - Only visible when expanded */}
                        {viewSubcategoriesModal.expandedChildren[sub._id] && (
                          <div className="pl-8 pr-3 pb-3 pt-2 bg-pink-50/30 border-t border-pink-100">
                            {!sub.children || sub.children.length === 0 ? (
                              <div className="text-center py-4">
                                <p className="text-xs text-gray-400">No child subcategories</p>
                                <button
                              ...
                              <div className="space-y-1">
                                {sub.children.map((child, childIdx) => (
                                  <div key={child._id} className="flex items-center justify-between p-2 bg-white rounded-lg border border-pink-100 hover:shadow-sm transition-shadow">
                                    <div className="flex items-center gap-3 flex-1">
                                      <span className="text-gray-400 text-xs font-mono w-6">{childIdx + 1}</span>
                                      <span className="text-sm font-medium text-gray-800">{child.name}</span>
                                ...
                                <button
                                  onClick={() => handleAddChildSubcategory(viewSubcategoriesModal.category, sub)}
                                  className="w-full mt-2 text-xs text-green-600 hover:text-green-700 flex items-center justify-center gap-1 py-1 border border-dashed border-pink-300 rounded-lg hover:bg-green-50"
                                >
                                  <Plus className="w-3 h-3" />
                                  Add Child Subcategory
                                </button>
            ...
            <div className="px-6 py-4 border-t border-pink-100 bg-gradient-to-r from-pink-50/30 to-rose-50/30 flex justify-end">
              <button
                onClick={() => handleAddSubcategory(viewSubcategoriesModal.category)}
                className="px-4 py-2 bg-gradient-to-r from-pink-500 to-rose-500 text-white text-sm rounded-lg hover:shadow-lg hover:shadow-pink-200/50 transition-all duration-300 flex items-center gap-2 shadow-md"
              >
                <Plus className="w-4 h-4" />
                Add Subcategory
              </button>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden border border-pink-100">
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-pink-50 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <form onSubmit={handleAddSubcategorySubmit} className="space-y-4">
                <div className="space-y-3">
                  <label className="block text-sm font-medium text-gray-700">
                    Subcategories <span className="text-rose-500">*</span>
                  </label>
                    ...
                    <div key={sub.id} className="flex items-center gap-2">
                      <div className="flex-1 relative">
                        <input
                          ...
                          value={sub.name}
                          onChange={(e) => updateSubcategoryName(sub.id, e.target.value)}
                          className="w-full px-3 py-2 text-sm border border-pink-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none bg-pink-50/30 hover:bg-white"
                          placeholder={`e.g., Subcategory ${index + 1}`}
                          autoFocus={index === subcategoryModal.subcategories.length - 1}
                        />
                        {index === 0 && (
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-pink-100">
                  <button
                    type="button"
                    onClick={() => setSubcategoryModal(prev => ({ ...prev, show: false }))}
                    className="px-4 py-2 text-sm font-medium text-gray-700 hover:bg-pink-50 rounded-lg transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={subcategoryModal.isSubmitting}
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-500 to-rose-500 text-white text-sm font-medium rounded-lg hover:shadow-lg hover:shadow-pink-200/50 transition-all duration-300 disabled:opacity-50 shadow-md"
                  >
                    {subcategoryModal.isSubmitting ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden border border-pink-100">
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setChildSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-pink-50 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <form onSubmit={handleAddChildSubcategorySubmit} className="space-y-4">
                <div className="space-y-3">
                  <label className="block text-sm font-medium text-gray-700">
                    Child Subcategories <span className="text-rose-500">*</span>
                  </label>
                    ...
                    <div key={child.id} className="flex items-center gap-2">
                      <div className="flex-1 relative">
                        <input
                          ...
                          value={child.name}
                          onChange={(e) => updateChildName(child.id, e.target.value)}
                          className="w-full px-3 py-2 text-sm border border-pink-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none bg-pink-50/30 hover:bg-white"
                          placeholder={`e.g., Child Subcategory ${index + 1}`}
                          autoFocus={index === childSubcategoryModal.children.length - 1}
                        />
                        {index === 0 && (
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-pink-100">
                  ...
                  <button
                    type="submit"
                    disabled={childSubcategoryModal.isSubmitting}
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-sm font-medium rounded-lg hover:shadow-lg hover:shadow-green-200/50 transition-all duration-300 disabled:opacity-50 shadow-md"
                  >
                    {childSubcategoryModal.isSubmitting ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
      ...
      {editSubcategoryModal.show && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 border border-pink-100">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                ...
                <button onClick={() => setEditSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-pink-50 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <form onSubmit={handleEditSubcategorySubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={editSubcategoryModal.name}
                    onChange={(e) => setEditSubcategoryModal(prev => ({ ...prev, name: e.target.value }))}
                    className="w-full px-3 py-2 text-sm border border-pink-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-pink-50/30 hover:bg-white"
                    placeholder="e.g., Casual Shirts"
                    autoFocus
                    required
                  />
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-pink-100">
                  ...
                  <button
                    type="submit"
                    disabled={editSubcategoryModal.isSubmitting}
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-medium rounded-lg hover:shadow-lg hover:shadow-blue-200/50 transition-all duration-300 disabled:opacity-50 shadow-md"
                  >
                    {editSubcategoryModal.isSubmitting ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 border border-pink-100">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setEditChildSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-pink-50 rounded-lg">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
              ...
              <form onSubmit={handleEditChildSubcategorySubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Child Subcategory Name <span className="text-rose-500">*</span>
                  </label>
                  <input
                    type="text"
                    value={editChildSubcategoryModal.name}
                    onChange={(e) => setEditChildSubcategoryModal(prev => ({ ...prev, name: e.target.value }))}
                    className="w-full px-3 py-2 text-sm border border-pink-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none bg-pink-50/30 hover:bg-white"
                    placeholder="e.g., Premium Quality"
                    autoFocus
                    required
                  />
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-pink-100">
                  ...
                  <button
                    type="submit"
                    disabled={editChildSubcategoryModal.isSubmitting}
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-sm font-medium rounded-lg hover:shadow-lg hover:shadow-indigo-200/50 transition-all duration-300 disabled:opacity-50 shadow-md"
                  >
                    {editChildSubcategoryModal.isSubmitting ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 border border-pink-100">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={handleEditClose} className="p-1 hover:bg-pink-50 rounded-lg transition-colors">
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
                ...
                <div>
                  ...
                  {!editModal.imagePreview ? (
                    <>
                      <div 
                        className={`border-2 border-dashed rounded-lg p-4 text-center cursor-pointer transition-colors ${
                          editModal.imageError ? 'border-rose-300 bg-rose-50' : 'border-pink-200 hover:border-pink-400 hover:bg-pink-50'
                        }`}
                        onClick={() => {
                          setEditModal(prev => ({ ...prev, imageError: '' }));
                          editFileInputRef.current?.click();
                      ...
                      >
                        <input 
                          ...
                          onChange={handleEditImageChange} 
                        />
                        <Upload className={`w-8 h-8 mx-auto mb-2 ${editModal.imageError ? 'text-rose-400' : 'text-pink-400'}`} />
                        <p className={`text-xs ${editModal.imageError ? 'text-rose-600' : 'text-gray-600'}`}>
                          Click to upload new image
                        </p>
                        <p className="text-xs text-gray-400 mt-2">
                          Allowed formats: JPG, JPEG, PNG, WebP (max 5MB)
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          type="button" 
                          onClick={handleEditRemoveImage}
                          className="flex-1 flex items-center justify-center gap-1 px-3 py-2 bg-rose-50 text-rose-600 text-xs font-medium rounded-lg hover:bg-rose-100 transition-colors"
                        >
                          <Trash2 className="w-3.5 h-3.5" />
                          Remove
                        </button>
      ...
      {deleteModal.show && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 border border-rose-100">
            <div className="p-6">
              ...
              <div className="flex items-center justify-end gap-3">
                ...
                <button
                  onClick={handleDeleteConfirm}
                  className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-rose-500 to-red-500 rounded-lg hover:shadow-lg hover:shadow-rose-200/50 transition-all duration-300 shadow-md"
                >
                  Delete Category
                </button>
              </div>
